   ...
   <div style='height: 40px;'></div>
        <div class="div_left_side" style='margin-bottom: 20px; margin-left: 30px;'>
          ...
          $r=mysqli_fetch_array($records);
           ...
           <div style="color:#C60; font-size:17; font-weight:600; margin:10px 0px 10px 5px" >Flat Description</div>
            <p id="prod_des"><?php echo  $r[8];?></p>

                  <div style='border-bottom:1px solid #f0f0f0; margin:20px 0px 20px 0px;'></div>

            <div style="color:#C60; font-size:17; font-weight:600; margin:10px 0px 10px 5px" >About Flat</div>
            <p id="prod_des"><?php echo  $r[8]; ?> </p>
 ...
 <div class ="div_right_side" style="margin-left: 30px;">
   <span style="font-size:22px; color:#111;"> <?php echo $r[2] ?> </span> <br/>
    <span style="font-size:22px; color:#111;"> <?php echo $r[1] ?> </span> <br/>
            ...
            <div  style='color:#bbb; font-size:14px;'>Flat Id :  <?php echo $r[9] ?> </div>
