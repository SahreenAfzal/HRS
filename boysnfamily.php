...
$con=mysqli_connect("localhost","root","","toletsystem");
    ...
    $res=mysqli_query($con,"select * from pgdetails where accomdation = 'For boys and family'and status='Approved'"); ?>

   <div  style='margin-top: 30px; margin-bottom: 30px;'> 
      <br/>
      <h1 style="text-align: center;font-family: 'Lobster', cursive; color:#c60;font-weight:900;"> Book Online PG for Boys and Family  </h1>
