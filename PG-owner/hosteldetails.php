...
include('db.php');
		...
		$records=mysqli_query($con,"select * from hosteldetails where id ='".$_GET['id']."'");
		?>

			<div class="details">
		<h1 style="text-align:center; font-weight:700;  font-family: cursive; color: burlywood;"> Hostel Details</h1><br><br>
...
<div style="display: inline-block;">
    ...
    <h1 class="h1"><?php echo"Status" .": &nbsp;"; echo $r[10];?></h1>
    <h1 class="h1"><?php echo"Date" .": &nbsp;"; echo $r[11];?></h1>
