...
<body>
	...
	<form method="POST" enctype="multipart/form-data"><br>
		...
		<h1 class="text-center" style="font-size: 40px; font-weight:900; font-family: cursive; ">Villa Details</h1>
		<div class="form-group">
            <label>Name</label>
            <input  type="text" name="villaname" class="form-control" style="background-color: whitesmoke;border: 1px solid black;">	
				</div>
				<div class="form-group">
            <label>villa Location</label>
            <input  type="text" name="villalocation" class="form-control" style="background-color:whitesmoke; border: 1px solid black;">					
				</div>
			<div class="form-group">
