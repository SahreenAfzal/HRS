...
$records=mysqli_query($con,"select * from pgdetails where pgownerid='".$_SESSION['pgid']."'");
  ?>
	...
	<div class="regist">
		...
		<table class="table table-stripped table-bordered"  style="z-index: -1">
			...
			?>
				...
				<?php $records=mysqli_query($con,"select * from hosteldetails  where pgownerid='".$_SESSION['pgid']."'"); ?>

		<br/><h1 style="font-family: 'Lobster', cursive;;font-weight: 900;">My Hostels</h1>
	...
	<?php $records=mysqli_query($con,"select * from details  where pgownerid='".$_SESSION['pgid']."'"); ?>

		<br><h1 style="font-family: 'Lobster', cursive;font-weight: 900;">My  Flat's & Villa's </h1>
		<table class="table table-stripped table-bordered">
			<?php
			  echo "<tr>";
			  echo "<th>Images</th>";
