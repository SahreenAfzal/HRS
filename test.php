...
<body>
   ...
   <div style='height: 40px;'></div>
        <div class="div_left_side" style='margin-bottom: 20px; margin-left: 30px; '>
           ...
           $records=mysqli_query($con,"select * from pgdetails where id= '48'");
           ...
           <div style="color:#C60; font-size:17; font-weight:600; margin:10px 0px 10px 5px" >Product description</div>
            <p id="prod_des"><?php echo  $r[5]; ?></p>

                  <div style='border-bottom:1px solid #f0f0f0; margin:20px 0px 20px 0px;'></div>

            <div style="color:#C60; font-size:17; font-weight:600; margin:10px 0px 10px 5px" >About manufacturer</div>
            <p id="prod_des"><?php echo  $r[5]; ?> </p>
 ...
 <div class ="div_right_side" style="margin-left: 30px;">
    <span style="font-size:22px; color:#111;"> <?php echo $r[1] ?> </span> <br/>
            ...
            <div  style='color:#bbb; font-size:14px;'>Product Id :  <?php echo $r[0] ?> </div>
            ...
            <tr> <td>  Rent: </td> <td style=' letter-spacing:1px; line-height: 1.9'><?php echo "&#8377;" ,$r[6] ?>  </td></tr>
             ...
             <tr> <td>   No.of Rooms: </td> <td style="letter-spacing:1px;line-height: 1.9" > &nbsp; &nbsp; <?php echo  $r[3]; ?></td>
    	   	  ...
    	   	  <tr> <td> PG For:</td> <td style='color:#b12704; font-size:19px; font-weight:600; line-height: 1.9 letter-spacing:1.2px;'> <?php echo $r[4] ?> </td> </tr>
                  ...
                  <br/>
                 <a id="buy_now" href='address.php?pid=<?php echo $_GET['pid'];?>' > Book Now </a>  
